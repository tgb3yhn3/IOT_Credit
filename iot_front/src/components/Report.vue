  ...
  data() {
    return {
      headers: [
        ...
        { text: 'Past 30-59 Days Delinquency', align: 'left', value: 'past_30_59' },
        { text: 'Income Ratio', align: 'left', value: 'income_ratio' },
        { text: 'Income', align: 'left', value: 'income' },
        { text: 'Current Credit Loan Case', align: 'left', value: 'current_credit_loan_case' },
        { text: 'Past 90 Days Delinquency', align: 'left', value: 'past_90' },
        { text: 'Current Mortgage Caseload', align: 'left', value: 'current_mortgage_caseload' },
        { text: 'Past 60-89 Days Delinquency', align: 'left', value: 'past_60_89' },
        { text: 'Number of Family Members', align: 'left', value: 'famliy_member_num' },
      ],
      desserts: [],
    };
  },
